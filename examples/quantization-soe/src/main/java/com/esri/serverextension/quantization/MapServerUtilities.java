...
public class MapServerUtilities {
    ...
    public static final List<IMapLayerInfo> getPolygonFeatureLayers(
    ...
    public static final IMapLayerInfo getPolygonFeatureLayerByID(int id,
                                                               ServerObjectExtensionContext serverContext) {
        List<IMapLayerInfo> layerInfoList = getPolygonFeatureLayers(serverContext);
    ...
    public static final IFeatureClass getPolygonFeatureClassByLayerID(int layerId,
                                                               ServerObjectExtensionContext serverContext) {
        try {
            IMapLayerInfo layerInfo = getPolygonFeatureLayerByID(layerId, serverContext);
            IMapServerDataAccess mapServerDataAccess = (IMapServerDataAccess) serverContext
                    .getServerObject();
            IMapServer3 mapServer = (IMapServer3) mapServerDataAccess;
            String mapName = mapServer.getDefaultMapName();
