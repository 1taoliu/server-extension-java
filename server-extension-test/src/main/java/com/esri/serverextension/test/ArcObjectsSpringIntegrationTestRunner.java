...
public class ArcObjectsSpringIntegrationTestRunner extends SpringJUnit4ClassRunner {
    private final Logger logger = LoggerFactory.getLogger(ArcObjectsIntegrationTestRunner.class);

    public ArcObjectsSpringIntegrationTestRunner(Class<?> clazz) throws InitializationError {
        super(clazz);
    }
    ...
    protected Statement classBlock(final RunNotifier notifier) {
        return new Statement() {
            ...
            public void evaluate() throws Throwable {
                ...
                try {
                    ArcObjectsSpringIntegrationTestRunner.super.classBlock(notifier).evaluate();
                } finally {
